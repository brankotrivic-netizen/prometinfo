...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "2.8.2026. 22:36",
  "text": "Vremenski uvjeti u većem dijelu zemlje povoljni su za vožnju. Vozi se bez posebnih zabrana i ograničenja, osim na dionicama gdje traju radovi. Pojačan je promet na prilazima turističkim središtima na obali te na pojedinim graničnim prijelazima, osobito s Crnom Gorom. Vozačima savjetujemo da prilagode brzinu i način vožnje uvjetima na cestama te održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: A1 Zagreb-Split-Dubrovnik povećana je gustoća prometa između čvorova Bosiljevo i Lučko u smjeru Zagreba pred naplatama Lučko u oba smjera i Demerje u smjeru Zagreba nema dužih čekanja DC1 Zagreb-Karlovac-Split u zoni radova između Knina i Gračaca kod Otrića vozi se usporeno Jadra…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "2.8.2026. 22:37",
