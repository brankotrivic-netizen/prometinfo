...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "30.6.2026. 00:57",
  "text": "Na većini cesta promet teče bez posebnih ograničenja, osim na dionicama gdje traju radovi. Pojačan je promet na važnijim cestama, gradskim cestama i obilaznicama te pojedinim graničnim prijelazima. Na cestama gdje su u tijeku radovi mogući su zastoji i vožnja u koloni. Vozačima savjetujemo da prilagode brzinu i način vožnje uvjetima na cestama. IZVANREDNI PROMETNI DOGAĐAJI: zbog prometne nesreće na autocesti A3 Bregana-Lipovac između čvorova Rugvica i Ivanić Grad u smjeru Lipovca vozi se zaustavnim trakom, a u smjeru Zagreba vozi se voznim trakom i zvanredni prijevozi na autocesti A4 između čvora Zagreb istok i čvora Popovec. Promet je kroz zonu radova privremeno u prekidu. AUTOCESTE A1 Zagr…"
 },
 {
