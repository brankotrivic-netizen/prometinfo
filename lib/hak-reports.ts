...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "5.8.2026. 18:49",
  "text": "Pojačan je promet na cestama u smjeru mora i unutrašnjosti. Zastoji su povremeno na dionicama cesta gdje traju radovi te na prilazima turističkim središtima. Vozače upozoravamo da prilagode brzinu i način vožnje uvjetima na cestama. IZVANREDNI PROMETNI DOGAĐAJI: zbog održavanja svečane proslave 31. obljetnice vojno-redarstvene akcije „Oluja“ te Dana pobjede i domovinske zahvalnosti i Dana hrvatskih branitelja zabrana je prometa na državnoj cesti DC1 u Kninu (obilazak državnom cestom DC33 Ulica kralja Tomislava-ŽC6080 ulica Domovinskog rata i obrnuto) te na državnoj cesti DC33 između Knina i Zvjerinca (obilazak županijskom cestom ŽC6058 Kosovo-Orlić-Biskupija-Kovačić i obrnuto, a za teretna v…"
 },
 {
