...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "8.9.2026. 18:51",
  "text": "Na većini cesta promet teče bez posebnih ograničenja, osim na dionicama gdje traju radovi. Pojačan je promet na gradskim cestama i obilaznicama. Vozačima savjetujemo da održavaju sigurnosni razmak između vozila te izuzetno oprezno i strpljivo voze u blizini škola i vrtića. IZVANREDNE PROMETNE SITUACIJE: prometna nesreća na autocesti A3 Bregana-Lipovac između čvorova Slavonski Brod zapad i Lužani, na 194. km + 100 u smjeru Bregane - vozi se jednim trakom, usporeno povećana gustoća prometa - vozi se usporeno uz povremene zastoje: na zagrebačkoj obilaznici (A3) između čvorova Lučko i Zagreb zapad u smjeru Bregane na Jadranskoj magistrali (DC8) u Solinu, Splitu, Stobreču, Omišu te između Promajn…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "8.9.2026. 18:20",
