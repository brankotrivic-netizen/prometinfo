...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "14.8.2026. 18:13",
  "text": "IZVANREDNI PROMETNI DOGAĐAJI: A1 Zagreb-Split-Dubrovnik: pred naplatama Demerje i Lučko u smjeru Zagreba kolone su oko 1 km na dionici između čvora Bosiljevo 2 i naplate Lučko u smjeru Zagreba mjestimice se vozi u kolonama u pokretu uz povremene zastoje A2 Zagreb-Macelj: kolona na naplati Trakošćan u smje ru Zagreba duga je oko 1 km, a na naplati Zaprešić u smjeru Krapine oko 500 metara zabranjen je promet za teretna vozila i autobuse između čvorova Krapina i Đurmanec u oba smjera A3 Bregana-Lipovac: životinja (srna) na kraku čvora Zagreb zapad - promet se vodi po dvije prometne trake u oba smjera uz ograničenje brzine od 60 km/h između čvorova Buzin i Zagreb istok u smjeru Lipovca vozi se u…"
 },
 {
