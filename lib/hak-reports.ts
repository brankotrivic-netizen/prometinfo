...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "3.8.2026. 18:01",
  "text": "Pojačan je promet na svim važnijim cestama u smjeru mora i unutrašnjosti, osobito na autocestama. Vozače upozoravamo da prilagode brzinu i način vožnje uvjetima na cestama. IZVANREDNI PROMETNI DOGAĐAJI: A1 Zagreb-Split-Dubrovnik vozi se usporeno u koloni uz povremene zastoje između čvorova Karlovac i Bosiljevo 2 u smjeru mora A6 Rijeka-Zagreb prometna nesreća na između čvorova Delnice i Ravna Gorau smjeru Zagreba, vozi se jednom prometnom trakom uz ograničenje brzine A7 Rupa-Šmrika pojačan je promet prema čvoru Šmrika od čvora Hreljin kolona je oko 2 km, preporuka je izlaz na čvoru Hreljin i čvoru Križišće korisnicima kojima je odredište Crikvenica/Novi Vinodolski na izlaznom kraku čvora Učk…"
 },
 {
