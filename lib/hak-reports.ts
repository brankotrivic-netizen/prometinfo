...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "28.8.2026. 01:40",
  "text": "Zastoji su povremeno na dionicama cesta gdje traju radovi. Vozače upozoravao da prilagode brzinu i način vožnje uvjetima na cestama. IZVANREDNI PROMETNI DOGAĐAJI: zbog radova na autocesti A6 Rijeka-Zagreb za sav je promet zatvorena dionica između čvorova Delnice i Oštrovica u oba smjera (obilazak je državnom cestom DC3 preko Gornjeg Jelenja) zbog prometne nesreće na Jadranskoj magistrali (DC8) u Rijeci (kod Kantride) vozi se usporeno. AUTOCESTE A1 Zagreb-Split-Dubrovnik NAJAVA RADOVA 28./29. kolovoza od 22:00 do 5:00 sati ujutro zbog izvođenja radova podizanja i implementacije portala novog sustava naplate cestarine u zonama naplatnih postaja Brinje, Perušić i Gospić, provest će se privremen…"
 },
 {
