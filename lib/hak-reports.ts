...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "6.8.2026. 15:04",
  "text": "Pojačan je promet na važnijim cestama, gradskim cestama i obilaznicama, prilazima turističkim središtima, trajektnim lukama i pristaništima te pojedinim graničnim prijelazima. Zastoji su povremeno na dionicama cesta gdje traju radovi. Vozače upozoravamo da prilagode brzinu i način vožnje uvjetima na cestama. IZVANREDNI PROMETNI DOGAĐAJI A1 Zagreb-Ploče-Karamatići pred naplatom Demerje u smjeru Zagreba kolona je oko 2 km, dok pred naplatom Lučko u oba smjera nema dužih čekanja između čvora Bosiljevo 2 i naplate Lučko u smjeru Zagreba mjestimice se vozi usporeno uz povremene zastoje A2 Zagreb-Macelj pred naplatom Trakošćan u smjeru Republike Slovenije kolona je oko 2 km povremeno se prekida pr…"
 },
 {
