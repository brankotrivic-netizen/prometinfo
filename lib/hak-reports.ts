...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "18.7.2026. 13:16",
  "text": "Promet je pojačan na svim važnijim cestovnim pravcima u smjeru mora i unutrašnjosti. U uvjetima povećane gustoće prometa i mjestimice mokrih kolnika upozoravamo vozače na pojačan oprez i održavanje sigurnosnog razmaka između vozila. IZVANREDNI PROMETNI DOGAĐAJI: A1 Zagreb-Split-Dubrovnik: kolona na prilazu naplati Lučko u oba smjera duga je oko 1 km, na naplati Demerje u smjeru Zagreba nema dužih čekanja između naplate Lučko i čvora Bosiljevo 2 u oba smjera, između čvora Gospić i tunela Sveti Rok u smjeru Dubrovnika te između tunela Čelinka i čvora Zadar istok u smjeru Zagreba vozi se u kolonama u pokretu s mogućim kratkotrajnim zastojima vozilo u kvaru na čvoru Posedarje u smjeru Zagreba, v…"
 },
 {
