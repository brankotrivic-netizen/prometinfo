...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "26.8.2026. 09:21",
  "text": "Magla mjestimice smanjuje vidljivost na cestama u unutrašnjosti. Povećana je gustoća prometa na gradskim cestama i obilaznicama. Vožnja u koloni i kraći zastoji mogući su u zonama radova i privremene regulacije prometa. Pozivamo vozače da brzinu i način vožnje prilagode uvjetima na cestama i održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: zbog prometne nesreće na autocesti A4 Goričan-Zagreb na kraku čvora Sesvete u smjeru Zagreba, vozi se jednim trakom uz ograničenje brzine od 40 km/h povećana je gustoća prometa, vozi se usporeno uz povremene zastoje: na zagrebačkoj obilaznici (A3) između čvorova Lučko i Zagreb zapad u smjeru Bregane na Krčkom mostu (DC102) kolona u …"
 },
 {
