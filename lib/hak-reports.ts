...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "4.7.2026. 21:38",
  "text": "Na većini cesta promet teče bez posebnih ograničenja, osim na dionicama gdje traju radovi. Na glavnim cestovnim pravcima većih gužvi i zastoja nema. IZVANREDNI PROMETNI DOGAĐAJI: zbog prometne nesreće zabrana prometa za sva vozila na državnoj cesti DC8 u Rijeci između Plumbuma i Viktora Lenca vozilo u kvaru (teretno vozilo) na autocesti A1 u tunelu Ledenik na kolniku u smjeru mora. Promet se vodi jednom prometnom trakom uz ograničenje brzine od 60 km/h AUTOCESTE A1 Zagreb-Split-Dubrovnik IZVANREDNI PRIJEVOZ do 31. srpnja od 23:00 sata do 05:00 sati. zbog isključivanja izvanrednih prijevoza, s glavne trase autoceste u zoni čvora Bisko višekratno će se zaustavljati promet u maksimalnim trajanj…"
 },
 {
