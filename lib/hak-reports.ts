...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "5.6.2026. 13:10",
  "text": "Kolnici su mjestimice mokri ili vlažni te skliski. Mogući su odroni. Pojačan je promet na gradskim cestama i obilaznicama te na važnijim cestama, osobito na Istarskom ipsilonu (A8/A9) između tunela i čvora Učka, te na Jadranskoj magistrali u Crikvenici, Solinu, Splitu i Stobreču te Krčkome mostu (DC102) u smjeru kopna. Na cestama gdje su u tijeku radovi mogući su zastoji i vožnja u koloni. Vozače upozoravamo da prilagode brzinu i način vožnje uvjetima na cestama te održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI : vožnja u suprotnom smjeru na autocesti A5 između čvora Beli Manastir i čvora Čepin na kolniku u smjeru BiH - vozi se uz ograničenje brzine od 40 km/h zbog v…"
 },
 {
