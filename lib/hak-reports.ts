...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "15.7.2026. 17:45",
  "text": "Mjestimice se vozi po mokrim i skliskim kolnicima. Pojačan je promet na gradskim cestama, obilaznicama, pojedinim dionicama autocesta i na cestama u priobalju. Vozačima savjetujemo da održavaju sigurnosni razmak između vozila. I ZVANREDNI PROMETNI DOGAĐAJI: zbog izvanrednog događaja, za sva je vozila zatvorena omiška obilaznica (DC553) između mjesta Naklice i Omiš zbog povećane gustoće prometa vozi se usporeno na: zagrebačkoj obilaznici (A3) između čvorova Lučko i Zagreb istok u smjeru Lipovca, u zoni radova na autocesti A4 između čvorova Zagreb istok i Popovec u smjeru Goričana i državnoj cesti DC1 između Gračaca i Knina kod Otrića. AUTOCESTE A1 Zagreb-Split-Dubrovnik IZVANREDNI PRIJEVOZ do…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "15.7.2026. 17:38",
