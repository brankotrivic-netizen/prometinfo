...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "13.9.2026. 10:33",
  "text": "U priobalju puše bura i ograničenja su za pojedine skupine vozila samo na omiškoj obilaznici (opširnije u izvješću) . Pojačan je promet na važniji cestama: Istarskom ipsilonu prema Kaštelu i Plovaniji, Krčkom mostu u smjeru kopna i pojedinim dionicama Jadranske magistrale, osobito između Jadranova i Crikvenice gdje se vozi u koloni uz zastoje. Molimo vozače da prilagode brzinu i način vožnje uvjetima na cestama te održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: zbog prometne nesreće Jadranskoj magistrali (DC8) Crikvenici kod skretanja za Zidarsku ulicu vozi se otežano, jednim kolničkim trakom. AUTOCESTE A1 Zagreb-Split-Dubrovnik IZVANREDNI PRIJEVOZ do 14. rujna u noć…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "13.9.2026. 10:09",
