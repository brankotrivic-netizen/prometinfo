...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "26.8.2026. 12:56",
  "text": "Povećana je gustoća prometa na gradskim cestama i obilaznicama. Vožnja u koloni i kraći zastoji mogući su u zonama radova i privremene regulacije prometa. Pozivamo vozače da brzinu i način vožnje prilagode uvjetima na cestama i održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: zbog prometne nesreće na autocesti A1 između čvorova Karlovac i Jastrebarsko, na 28. km u smjeru Zagreba, vozi se po dva traka u koloni od oko 2 km povećana je gustoća prometa, vozi se usporeno uz povremene zastoje: na zagrebačkoj obilaznici (A3) između čvorova Lučko i Zagreb zapad u smjeru Bregane na Istarskom ipsilonu (A8) kolona na čvoru Matulji u smjeru Rijeke je oko 1 km AUTOCESTE A1 Zagreb-…"
 },
 {
