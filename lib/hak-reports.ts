...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "8.8.2026. 23:49",
  "text": "Zbog vjetra zabrane su za pojedine za pojedine skupine vozila na dijelu Jadranske magistrale (opširnije u popisu cesta). Na glavnim cestovnim pravcima nema većih gužvi i zastoja. Vozače podsjećamo da održavaju sigurnosni razmak između vozila, a u slučaju zastoja formiraju hitni koridor. IZVANREDNI PROMETNI DOGAĐAJI životinja (lisica) na autocesti A1 između tunela Brezik i tunela Plasina - vozi se uz ograničenje brzine od 80 km/h ozilo u kvaru (autobus) na autocesti A1 između tunela Bristovac i tunela Čelinka u smjeru Zagreba- vozi se uz ograničenje brzine od 40 km/h AUTOCESTE A1 Zagreb-Split-Dubrovnik IZVANREDNI PRIJEVOZ do 12. kolovoza od 01:00 sat do 05:00 sati privremena zaustavljanja pro…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "8.8.2026. 22:12",
