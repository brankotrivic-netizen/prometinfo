...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "31.7.2026. 08:34",
  "text": "Vožnja u suprotnom smjeru na autocesti A1 između čvora Donja Zdenčina i naplatne postaje ČCP Demerje na kolniku u smjeru Zagreba. Vozi se uz ograničenje brzine od 40 km/h. Molimo korisnike za oprez. Na većini cesta vozi se bez većih ograničenja ili poteškoća. Zastoji su povremeno u zonama radova. Pojačan je promet na važnijim cestama, gradskim cestama i obilaznicama, pojedinim graničnim prijelazima te trajektnim lukama i pristaništima. Vozače upozoravamo da prilagode brzinu i način vožnje uvjetima na cestama te da održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: A1 Zagreb-Ploče-Karamatići pred naplatom Lučko u oba smjera nema dužih čekanja povećana je gustoća prometa …"
 },
 {
