...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "21.7.2026. 11:05",
  "text": "Kolnici su mjestimice mokri ili samo vlažni i skliski. U priobalju puše bura, zabrane su za pojedine skupine vozila samo na Jadranskoj magistrali (vidjeti niže u Izvješću!). Vozačima savjetujemo da brzinu i način vožnje prilagode uvjetima na cestama te održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: zagrebačka obilaznica (A3): zona radova između čvorova Lučko i Jankomir - u smjeru Bregane vozi se usporeno u koloni, duga je oko 2 km na autocesti A2 Zagreb-Macelj: kolona vozila kod naplatnih postaja Trakošćan u smjeru Zagreba duga je oko 500 m Krčki most: pojačan promet u smjeru kopna, vozi se usporeno od Njivica AUTOCESTE A1 Zagreb-Split-Dubrovnik IZVANREDNI PRIJEVOZ …"
 },
 {
  "title": "Granični prijelazi",
  "updated": "21.7.2026. 10:55",
