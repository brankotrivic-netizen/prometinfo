...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "7.7.2026. 15:18",
  "text": "Vremenski uvjeti u većem dijelu zemlje povoljni su za vožnju. Pojačan je promet na gradskim prometnicama i obilaznicama te na prilazima turističkim središtima u priobalju. Povremeni zastoji mogući su u zonama radova i privremene regulacije prometa. Pozivamo vozače da brzinu i način vožnje prilagode uvjetima na cestama i drže sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: povećana gustoća prometa na autocesti A1 između čvorova Lučko i Karlovac u oba smjera povećana gustoća prometa na zagrebačkoj obilaznici (A3) između čvorova Jakuševec i Zagreb istok u smjeru Lipovca, vozi se u sporeno uz povremene zastoje zbog prometne nesreće na državnoj cesti DC3 u mjestu Soboli vozi se ote…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "7.7.2026. 15:02",
