...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "5.8.2026. 07:57",
  "text": "Na većini cesta vozi se bez posebnih ograničenja, osim na dionicama gdje traju radovi. Povećana je gustoća prometa na važnijim cestovnim pravcima u smjeru mora. Vozače upozoravamo da prilagode brzinu i način vožnje uvjetima na cestama i održavaju sigurnosni razmak između vozila , a u slučaju zastoja formiraju hitni koridor. IZVANREDNI PROMETNI DOGAĐAJI: životinja (krava) na autocesti A3 između čvorova Okučani i Novska u smjeru Bregane, vozi se po dva prometna traka uz ograničenje brzine 80 km/h zbog održavanja svečane proslave 31. obljetnice vojno-redarstvene akcije „Oluja“ te Dana pobjede i domovinske zahvalnosti i Dana hrvatskih branitelja zabrana je prometa na državnoj cesti DC1 u Kninu (…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "5.8.2026. 07:52",
