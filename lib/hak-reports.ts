...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "5.6.2026. 14:15",
  "text": "Kolnici su mjestimice mokri ili vlažni te skliski. Mogući su odroni. Pojačan je promet na gradskim cestama i obilaznicama te na važnijim cestama, osobito na Istarskom ipsilonu (A8/A9) između tunela i čvora Učka, Jadranskoj magistrali (DC8) u Crikvenici, Solinu, Splitu i Stobreču te Krčkome mostu (DC102) u smjeru kopna. Na cestama gdje su u tijeku radovi mogući su zastoji i vožnja u koloni. Vozače upozoravamo da prilagode brzinu i način vožnje uvjetima na cestama te održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI : vožnja u suprotnom smjeru na autocesti A3 Bregana-Lipovac između čvora Sveta Nedelja i čvora Samobor na kolniku u smjeru Lipovca - vozi se uz ograničenje br…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "5.6.2026. 14:02",
