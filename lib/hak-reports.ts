...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "9.9.2026. 19:02",
  "text": "Kolnici su mjestimice mokri ili vlažni i skliski. Pojačan je promet na gradskim cestama, obilaznicama i pojedinim dionicama autocesta, a zastoji i kolone su u zonama radova i privremene regulacije prometa. Vozačima savjetujemo da prilagode brzinu i način vožnje uvjetima na cestama te održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: A3 Bregana-Lipovac na zagrebačkoj obilaznici (A3) između čvorova Lučko i Zagreb zapad u smjeru Bregane vozi se usporeno uz povremkene zastoje, zbog povećane gustoće prometa POČETAK NASTAVNE GODINE: Počela je nova nastavna godina, zbog čega je u prometu velik broj školaraca. S obzirom da su pješaci, osobito djeca, najosjetljiviji sudionici u…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "9.9.2026. 18:07",
