...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "26.8.2026. 13:15",
  "text": "Povećana je gustoća prometa na gradskim cestama i obilaznicama. Vožnja u koloni i kraći zastoji mogući su u zonama radova i privremene regulacije prometa. Pozivamo vozače da brzinu i način vožnje prilagode uvjetima na cestama i održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: povećana je gustoća prometa, vozi se usporeno uz povremene zastoje: na autocesti A1 između čvorova Novigrad i Jastrebarsko u smjeru Zagreba na zagrebačkoj obilaznici (A3) između čvorova Lučko i Zagreb zapad u smjeru Bregane na Istarskom ipsilonu (A8) na čvoru Matulji u smjeru Rijeke kolona je oko 1 km AUTOCESTE A1 Zagreb-Split-Dubrovnik NAJAVA RADOVA 28./29. kolovoza od 22:00 do 5:00 sati ujutro …"
 },
 {
