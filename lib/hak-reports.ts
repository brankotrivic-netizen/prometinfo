...
export const HAK_REPORTS: HakReport[] = [
 ...
 },
 {
  ...
  "updated": "7.9.2026. 18:37",
  "text": "Prometna prognoza za Hrvatsku za 08. rujna 2026. U većem dijelu zemlje vozit će se uz povoljne vremenske uvjete. Pojačan promet očekuje se na gradskim cestama, obilaznicama i pojedinim dionicama autocesta, osobito na zagrebačkoj obilaznici te na autocestama A2 Zagreb-Macelj kod čvora Zagreb zapad i A4 Goričan-Zagreb između čvorova Popovec i Zagreb istok. Zastoje i kolone očekujte u zonama radova, osobito tijekom jutra i poslijepodneva. Vozačima savjetujemo da prilagode brzinu i način vožnje uvjetima na cestama te da posebno oprezno i strpljivo voze u blizini škola i vrtića. Pojačan promet putničkih vozila očekuje se na većni graničnih prijelaza s Bosnom i Hercegovinom te pojedinim granicama …"
 },
 {
  "title": "Vožnja po mokrim i skliskim kolnicima",
  "updated": "6.9.2026. 20:48",
