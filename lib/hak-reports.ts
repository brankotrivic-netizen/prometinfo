...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "12.9.2026. 10:07",
  "text": "Magla mjestimice smanjuje vidljivost na cestama u unutrašnjosti zemlje. Na cestama gdje ima magle kolnici su vlažni i skliski. Mogući su odroni. U priobalju puše jak vjetar i ograničenja za pojedine skupine vozila su na dijelovima Jadranskoj magistrali (opširnije u izvješću) . Zastoji su povremeno mogući na dionicama cesta gdje traju radovi. Vozače podsjećamo da u uvjetima smanjene vidljivosti voze s upaljenim svjetlima, da prilagode brzinu i način vožnje uvjetima na cestama te da održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: prometna nesreća na autocesti A3 Bregana-Lipovac na 167.+700 km između čvorova Nova Gradiška i Lužani u smjeru Lipovca - vozi se jednim prome…"
 },
 {
