...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "5.7.2026. 09:30",
  "text": "Na većini cesta promet teče bez posebnih ograničenja, uz povoljne vremenske uvjete. Ovisno o gustoći prometa, zastoji i kolone povremeno su u zonama radova, tunela, odmorišta i naplata te na prilazima turističkim središtima. U trajektnim lukama i pristaništima te na pojedinim graničnim prijelazima moguća su i dulja čekanja. Vozače molimo za oprez, strpljenje i koncentraciju te da održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: A1 Zagreb-Ploče-Karamatići: povećana gustoća prometa između Zagreba i Karlovca u smjeru mora prometna nesreća između čvorova Zadar centar i Zadar istok u smjeru Dubrovnika (ograničenje brzine: 80 km/h) A2 Zagreb-Macelj: pred naplatnom postajom …"
 },
 {
  "title": "Granični prijelazi",
  "updated": "5.7.2026. 08:26",
