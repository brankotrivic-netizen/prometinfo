...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "6.9.2026. 19:35",
  "text": "Pojačan je promet na većini cesta u smjeru unutrašnjosti. Vozačima savjetujemo da prilagode brzinu i način vožnje uvjetima na cestama te održavaju sigurnosni razmak između vozila. IZVANREDNE PROMETNE SITUACIJE: A1 Zagreb-Split-Dubrovnik kod naplatnih postaja Lučko u oba smjera i Demerje u smjeru Zagreba nema dužih kolona (do 1 km) nakon sanacije požara na vozilu otvoren je tunel Bristovac u smjeru Zagreba, kolona je oko 2 km A3 Bregana-Lipovac na zagrebačkoj obilaznici vozi se usporeno između čvorova Lučko i Zagreb zapad u smjeru Bregane DC102 Krčki most pojačan je promet u smjeru kopna, vozi se usporeno od Njivica DC501 Oštrovica-Meja zbog prometne nesreće vozi se jednim trakom, otežano POČ…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "6.9.2026. 17:40",
