...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "26.6.2026. 23:02",
  "text": "Na većini cesta promet teče bez posebnih ograničenja, osim na dionicama gdje traju radovi. Vozačima savjetujemo da prilagode brzinu i način vožnje uvjetima na cestama. IZVAN REDNI PROMETNI DOGAĐAJI: - AUTOCESTE A1 Zagreb-Ploče-Karamatići A2 Zagreb-Macelj - A3 Bregana-Lipovac do 26. lipnja zbog radova na dionici Zagreb zapad- čvora Sveta Nedelja (od 13.+ 600 do 12.+700 km) u smjeru Bregane vozi se po dva sužena prometna traka servisnim kolnikom (smjer Rakitje, Ježdovec, Kerestinec) u smjeru Bregane zbog prometnog rasterećenja privoza čvoru Zagreb zapad (Jankomir) iz smjera Lipovca (A3) u smjeru Grada Zagreba, iz smjera Bregane (A3) i Macelja (A2) u smjeru Grada Zagreba (most Sava - Jankomir),…"
 },
 {
