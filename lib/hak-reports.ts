...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "18.7.2026. 15:50",
  "text": "Promet je pojačan na svim važnijim cestovnim pravcima u smjeru mora i unutrašnjosti te na pojedinim dionicama Jadranske magistrale (DC8). U uvjetima povećane gustoće prometa i mjestimice mokrih kolnika upozoravamo vozače na pojačan oprez i održavanje sigurnosnog razmaka između vozila. IZVANREDNI PROMETNI DOGAĐAJI: A1 Zagreb-Split-Dubrovnik: između naplate Lučko i čvora Bosiljevo 2 u oba smjera te između čvorova Gospić i Rovanjska u smjeru juga vozi se u kolonama u pokretu s mogućim kraćim zastojima na naplatama Lučko u oba smjera i Demerje u smjeru Zagreba nema dužih čekanja A2 Zagreb-Macelj: na naplatnoj postaji Trakošćan u smjeru Zagreba kolona je duga oko 5 km (proteže se u Sloveniju) zbo…"
 },
 {
