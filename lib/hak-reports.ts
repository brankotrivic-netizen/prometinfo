...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "25.8.2026. 17:53",
  "text": "Kolnici su mjestimice mokri i skliski. Pojačan je promet na gradskim prometnicama, obilaznicama i pojedinim dionicama autocesta. Vožnja u koloni i kraći zastoji mogući su u zonama radova i privremene regulacije prometa. Pozivamo vozače da brzinu i način vožnje prilagode uvjetima na cestama i održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: A3 Bregana-Lipovac zbog povećane gustoće prometa vozi se usporeno, u kolonama u pokretu, između čvorova Buzin i Zagreb zapad u smjeru Bregane Jadranska magistrala (DC8) prometne nesreće: u mjestu Bibinje (vozi se uz ograničenje brzine 30 km/h) i kod Murvice Donje (vozi se naizmjence, jednim trakom, uz ograničenje brzine 30 km/h) AUT…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "25.8.2026. 17:51",
