...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "19.8.2026. 13:54",
  "text": "Promet je pojačan na autocestama u smjeru mora i unutrašnjosti. Zastoji su povremeno na dionicama cesta gdje traju radovi te na gradskim prometnicama. Vozače upozoravamo da prilagode brzinu i način vožnje uvjetima na cestama. IZVANREDNI PROMETNI DOGAĐAJI: A1 Zagreb-Split-Dubrovnik prometna nesreća između čvora Novigrad i čvora Karlovac (na 41+500 km) u smjeru Zagreba, vozi se jednom prometnom trakom prometna nesreća između čvora Karlovac i čvora Jastrebarsko (na 35+000 km) u smjeru Zagreba, vozi se po dvije prometne trake uz ograničenje brzine od 100 km/h pred naplatnim postajama Demerje i Lučko u smjeru Zagreba kolone su oko 1 km A3 Bregana-Lipovac prometna nesreća između čvora Lučko i čvor…"
 },
 {
