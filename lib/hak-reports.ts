...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "22.8.2026. 18:54",
  "text": "Kolnici su mjestimice mokri i skliski. Mogući su i odroni, osobito na cestama u gorju i na Jadranskoj magistrali (DC8). Pojačan je promet na važnijim cestama te pojedinim graničnim prijelazima. Vozače upozoravamo da brzinu i način vožnje prilagode uvjetima na cestama i održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: A1 Zagreb-Ploče-Karamatići prometna nesreća u tunelu Brezik na kolniku u smjeru Zagreba, vozi se jednom prometnom trakom u koloni dionica između čvorova Otočac i Perušić otvorena je u oba smjera nakon prometne nesreće pojačan je promet u smjeru Zagreba između čvorova Gospić i Žuta Lokva vozi se u kolonama uz povremene zastoje pojačan je promet između čvor…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "22.8.2026. 18:51",
