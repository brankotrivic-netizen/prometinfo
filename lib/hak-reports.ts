...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "12.9.2026. 13:58",
  "text": "U priobalju puše bura i ograničenja za pojedine skupine vozila su na dijelovima Jadranske magistrale (opširnije u izvješću) . Promet je pojačan na važnijim cestama u smjeru mora i u smjeru unutrašnjosti. Zastoji su povremeno na autocestama u zonama naplatnih postaja, tunela, čvorova i odmorištima te na ostalim cestama u zonama radova. Vozače podsjećamo da prilagode brzinu i način vožnje uvjetima na cestama te da održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: A1 Zagreb-Split-Dubrovnik OPREZ! predmet na 325.+000 km između čvorova Podi i Šibenik u smjeru Zagreba - vozi se jednim prometnim trakom uz ograničenje brzine od 40 km/h između čvorova Bosiljevo i Lučko u smjeru…"
 },
 {
