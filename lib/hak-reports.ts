...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "16.8.2026. 14:02",
  "text": "Povećana je gustoća prometa na važnijim cestovnim pravcima u smjeru mora i unutrašnjosti, na cestama u priobalju te na većini graničnih prijelaza. Vozače upozoravamo da brzinu i način vožnje prilagode uvjetima na cestama i održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: A1 Zagreb-Ploče-Karamatići između čvorova Novigrad i Bosiljevo 2 u smjeru mora, čvorova Ogulin i Lučko te čvora Posedarje i tunela Bristovac u smjeru Zagreba mjestimice se vozi u kolonama u pokretu s kraćim zastojima na naplatama Lučko i Demerje u smjeru Zagreba kolone su duge oko 1 km A2 Zagreb-Macelj zbog povećanog priljeva vozila zabranjen je promet za teretna vozila i autobuse između čvorova Krapi…"
 },
 {
