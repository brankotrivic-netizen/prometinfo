...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "15.7.2026. 19:31",
  "text": "Mjestimice se vozi po mokrim i skliskim kolnicima. Pojačan je promet na gradskim cestama, obilaznicama, pojedinim dionicama autocesta i na cestama u priobalju. Vozačima savjetujemo da održavaju sigurnosni razmak između vozila. I ZVANREDNI PROMETNI DOGAĐAJI: zbog izvanrednog događaja, za sva je vozila zatvorena omiška obilaznica (DC553) između mjesta Naklice i Omiš zbog povećane gustoće prometa vozi se usporeno u zoni radova na državnoj cesti DC1 između Gračaca i Knina kod Otrića AUTOCESTE A1 Zagreb-Split-Dubrovnik IZVANREDNI PRIJEVOZ do 31. srpnja od 23:00 sata do 05:00 sati. zbog isključivanja izvanrednih prijevoza, s glavne trase autoceste u zoni čvora Bisko višekratno će se zaustavljati p…"
 },
 {
