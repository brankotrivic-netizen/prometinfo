...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "25.8.2026. 19:56",
  "text": "Kolnici su mjestimice mokri i skliski. Pojačan je promet na gradskim prometnicama i obilaznicama. Vožnja u koloni i kraći zastoji mogući su u zonama radova i privremene regulacije prometa. Pozivamo vozače da brzinu i način vožnje prilagode uvjetima na cestama i održavaju sigurnosni razmak između vozila. A1 Zagreb-Ploče-Karamatići vozi se bez gužvi i zastoja, na naplatama Lučko u oba smjera i Demerje u smjeru Zagreba nema dužih čekanja IZVANREDNI PROMETNI DOGAĐAJI: Jadranska magistrala (DC8) prometna nesreća u mjestu Bibinje, vozi se uz ograničenje brzine 30 km/h AUTOCESTE A1 Zagreb-Split-Dubrovnik IZVANREDNI PRIJEVOZ do 05. rujna od 22:00 sata do 05:00 sati izvanredni prijevoz kretat će se n…"
 },
 {
