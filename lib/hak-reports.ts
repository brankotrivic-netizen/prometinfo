...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "9.6.2026. 12:16",
  "text": "Pojačan je promet na gradskim cestama i obilaznicama, a zastoji su mogući u zonama radova i privremene regulacije prometa, osobito na Istarskom ipsilonu (A8) između čvora i tunela Učka te na nekoliko dionica Ličke (DC1) i Jadranske (DC8) magistrale. Vozače upozoravamo da prilagode brzinu i način vožnje uvjetima na cestama te održavaju sigurnosni razmak između vozila. IZVANREDNI PROMETNI DOGAĐAJI: zbog prometne nesreće na Jadranskoj magistrali (DC8) između Vodica i Šibenika, kod skretanja za Srimu, vozi se jednom trakom u regulaciju prometne policije A1 Zagreb-Ploče-Karamatići d o 19. lipnja zatvorena je dionica između čvorova Bisko i Split u smjeru Zagreba. Obilazak: čvor Bisko (izlaz sa aut…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "9.6.2026. 12:11",
