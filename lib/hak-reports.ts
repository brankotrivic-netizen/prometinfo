...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "18.7.2026. 08:05",
  "text": "Promet je pojačan na svim važnijim cestovnim pravcima u smjeru juga. U uvjetima povećane gustoće prometa upozoravamo vozače na pojačan oprez i održavanje sigurnosnog razmaka između vozila. IZVANREDNI PROMETNI DOGAĐAJI: A1 Zagreb-Split-Dubrovnik: životinja (srna) na 44. km između čvorova Karlovac i Novigrad, vozi se uz ograničenje brzine 80 km/h na naplatama Lučko i Demerje u smjeru Zagreba nema dužih čekanja između naplate Lučko i čvora Bosiljevo 2 u smjeru Dubrovnika vozi se u kolonama u pokretu s mogućim kratkotrajnim zastojima A2 Zagreb-Macelj: na naplatnoj postaji Trakošćan u smjeru Zagreba kolona je duga oko 6 km (proteže se u Sloveniju) vozi se usporeno u zoni radova između čvorova Tra…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "18.7.2026. 08:03",
