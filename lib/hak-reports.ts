...
export const HAK_REPORTS: HakReport[] = [
 {
  ...
  "updated": "22.6.2026. 12:15",
  "text": "Promet je pojačan na važnijim cestama u smjeru kopna, ali i u smjeru mora. Zastoji su u zonama radova, osobito na autocesti A6 Rijeka-Zagreb između čvorova Bosiljevo 2 i Vrbovsko u smjeru Rijeke, Istarskom ispsilonu između tunela i čvora Učka, na pojednim dionicama Jadranske (DC8) i Ličke magistrale (DC1), na Krčkom mostu te u trajektnim lukama i pristaništima . Podsjećamo vozače da su uz veću gustoću prometa češći i izvanredni događaji koji dodatno usporavaju promet, kao što su prometne nesreće. Kako bi promet bio što sigurniji za sve sudionike, molimo vozače da prilagode brzinu i način vožnje uvjetima na cestama te održavaju sigurnosni razmak između vozila. IZVAN REDNI PROMETNI DOGAĐAJI: v…"
 },
 {
  "title": "Granični prijelazi",
  "updated": "22.6.2026. 10:54",
